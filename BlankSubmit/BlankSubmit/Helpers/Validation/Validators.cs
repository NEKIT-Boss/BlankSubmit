...
// ***********************************************************************
// <copyright file="Validators.cs" company="XLabs Team">
...
namespace BlankSubmit.Helpers.Validation
{
	...
	public enum Validators : ulong
	{
		...
		/// <summary>The numeric value is between <see cref="XLabs.Forms.Validation.Rule.Minimum" /> and <see cref="XLabs.Forms.Validation.Rule.Maximum" />/></summary>
